...
PRESS_REGISTRY = {
    ...
    "merging_critical_snapkv_t08": MergingPress(CriticalKVPress(SnapKVPress()), similarity_threshold=0.8),
    "merging_snapkv": MergingPress(SnapKVPress()),
    "merging_snapkv_t08": MergingPress(SnapKVPress(), similarity_threshold=0.8),
